...
export default function SettingsPage() {
  ...
  const settingsNavigation = [
    {
      name: 'Team',
      href: `/${agencySlug}/settings/team`,
      icon: Users,
      description: 'Manage team members and permissions',
    },
    {
      name: 'Payments',
      href: `/${agencySlug}/settings/payments`,
      icon: CreditCard,
      description: 'Connect Stripe and manage payment settings',
    },
    {
      name: 'Agency Profile',
      href: `/${agencySlug}/settings/agency`,
      icon: Building2,
      description: 'Update agency information and branding',
    },
    {
      name: 'Notifications',
      href: `/${agencySlug}/settings/notifications`,
      icon: Bell,
      description: 'Configure email and push notifications',
    },
    {
      name: 'Security',
      href: `/${agencySlug}/settings/security`,
      icon: Shield,
